...
<body><div>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
<h2>INPUT DATA KATEGORI</h2></div>
<form name="form1" method="post" action="aksi/simpankategori.php">
<table>
<tr>
<td>Nama Kategori</td>
<td><input class="w3-input w3-animate-input" style="width:70%" type="text" name="nama_kategori" size="30"/></td>
</tr>
