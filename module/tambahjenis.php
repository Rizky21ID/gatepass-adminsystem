...
<body><div>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
<h2>INPUT DATA JENIS KENDARAAN</h2></div>
<form name="form1" method="post" action="aksi/simpanjenis.php">
<table>
<tr>
<td>Nama Jenis Kendaraan</td>
<td><input class="w3-input w3-animate-input" style="width:30%" type="text" name="nama_jenis" size="30"/></td>
</tr>
