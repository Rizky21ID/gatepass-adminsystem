...
<body><div>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
<h2>INPUT DATA PEMILIK</h2></div>
<form name="form1" method="post" action="aksi/simpanpemilik.php">
<table>
<tr>
<td>Nama Pemilik</td>
<td><input class="w3-input w3-animate-input" style="width:70%" type="text" name="nama_pemilik" size="30"/></td>
</tr>
